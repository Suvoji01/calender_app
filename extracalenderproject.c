...
int main(){
    ...
    SetConsoleTitle("Calender Project - Knowledge 360");
    int choice;
    char ch = 'a';
    while(1){
        system("cls");
        ...
        system("cls");
        switch(choice){
            case 1://Find the day which can u search//
                ...
                getch();
                break;
            case 2 ://print all the day of month//
                ...
                break;
            case 3://In this case we can add the Note//
                AddNote();
                break;
            case 4 ://In this case we can exit
                exit(0);
        }
    }
    return 0;
